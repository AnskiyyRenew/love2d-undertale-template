-- Auto-generated by love-api (https://github.com/love2d-community/love-api)
-- LOVE2D version: 11.5
local se = {}
...
--[[ Methods of the object types under se.audio (reference only,
     not injected into the se table):
...
--[[ Methods of the object types under se.data (reference only,
     not injected into the se table):
  ByteData: 
...
--[[ Methods of the object types under se.filesystem (reference only,
     not injected into the se table):
  DroppedFile: 
...
--[[ Methods of the object types under se.font (reference only,
     not injected into the se table):
...
--[[ Methods of the object types under se.graphics (reference only,
     not injected into the se table):
...
--[[ Methods of the object types under se.image (reference only,
     not injected into the se table):
...
--[[ Methods of the object types under se.joystick (reference only,
     not injected into the se table):
...
--[[ Methods of the object types under se.math (reference only,
     not injected into the se table):
...
--[[ Methods of the object types under se.mouse (reference only,
     not injected into the se table):
  Cursor: getType
]]
...
--[[ Methods of the object types under se.physics (reference only,
     not injected into the se table):
...
--[[ Methods of the object types under se.sound (reference only,
     not injected into the se table):
...
--[[ Methods of the object types under se.thread (reference only,
     not injected into the se table):
...
--[[ Methods of the object types under se.video (reference only,
     not injected into the se table):
...
local proxy_mt = {
    __index = function(t, key)
        if type(love[key]) == "table" then
            -- Create the proxy table for this module
